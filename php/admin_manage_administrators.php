...
<head>
    ...
    <script type="text/javascript" src="../javascript/admin_script.js"></script>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="form-group">
                    ...
                    <input type="text" id="password" placeholder="_Username-Last Name-First Name_" class="form-control"/>
                </div>

            </div>
            <div class="modal-footer">
                <button type="button" class="btn btn-default" data-dismiss="modal">Cancel</button>
                <button type="button" class="btn btn-primary" onclick="addRecord()">Add Administrator</button>
            </div>
        </div>
    </div>
</div>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="form-group">
                    <label for="houseNumber">Position</label>
                    <input type="text" id="update_position" placeholder="House Number" class="form-control"/>
                </div>
            ...
            <div class="modal-footer">
                ...
                <input type="hidden" id="hidden_adminID">
            </div>
        </div>
    </div>
</div>
