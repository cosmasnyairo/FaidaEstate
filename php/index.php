  ...
  <div class="chat_message_area">
   ...
   <div class="image_upload">
    <form id="uploadImage" method="post" action="upload.php">
     <label for="uploadFile"><img src="../images/upload.jpg" /></label>
     <input type="file" name="uploadFile" id="uploadFile" accept=".jpg, .png .docx, .txt" />
    </form>
   </div>
  </div>
 </div>
...
$(document).ready(function(){
 ...
 function make_chat_dialog_box(to_user_id, to_user_name)
 {
  ...
  modal_content += '<div style="height:300px; border:1px solid #ccc; overflow-y: scroll; margin-bottom:9px; padding:6px;" class="chat_history" data-touserid="'+to_user_id+'" id="chat_history_'+to_user_id+'">';
 ...
 $(document).on('click', '.start_chat', function(){ //code execute on click startchart button
  ...
  $('#chat_message_'+to_user_id).emojioneArea({
   pickerPosition:"top",  //where emoji willbe in our text area field
   toneStyle: "bullet"
  });
 ...
 $(document).on('click', '.send_chat', function(){
  ...
  $.ajax({
   ...
   success:function(data)
   {
    ...
    var element = $('#chat_message_'+to_user_id).emojioneArea();  //clears text field
...
function fetch_user_chat_history(to_user_id)
 ...
 $(document).on('click', '.ui-button-icon', function(){   
  ...
  var is_type = 'yes';      //if user is in txt box
  $.ajax({
 ...
 $(document).on('blur', '.chat_message', function(){
  var is_type = 'no';        //if cursor isn't in the testbox
  $.ajax({
   url:"typing_status.php",
   method:"POST",
   data:{is_type:is_type},
